...
for(let pep of got.houses[1].people)
{
  console.log(`I am ${pep.name} and my bio is ${pep.description}`);
}
...
for(let houseName of houseNames)
{
...
for(let house of got.houses)
{
  for(let pep of house.people)
  {
    allDescription.push(pep.description);
  }
}
